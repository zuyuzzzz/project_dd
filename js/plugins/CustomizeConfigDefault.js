...
// ----------------------------------------------------------------------------
// Version
// 1.1.0 2016/08/01 追加了一项项目本身的功能。
// 1.0.3 2016/06/22 競爭對策
// 1.0.2 2016/01/17 競合対策
// 1.0.1 2015/11/01 修正現有程式碼的再定義方法（內容沒有變化）
// 1.0.0 2015/11/01 初版
// ----------------------------------------------------------------------------
 ...
 * @default OFF
 *
 * @help 选择画面设定可能的项目的默认值指定了值变更。
 * 例如，如果从第一次开始就经常在合适的话
 * 播放器可以节省设置设置的工夫。
 * 这种处理config . rpgsave未作成时才被实行。
 *
 * 可以把项目本身消去。
 * 例如，战斗没有的游戏「指令记忆」等不需要。
 *
 * 这个插件没有插件命令。
 *
 * 利用規約：
